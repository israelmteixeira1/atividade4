...
public class TesteApp {
	...
	public void testeCrudCurso(CursoCtrl ctrl) {
		...
		System.out.println("--------------------------------------------------");
		/* Inserir Cursos */
		Curso curso1 = new Curso(null, "Ciencias da computação");
		Curso curso2 = new Curso(null, "Eng. Software");
		Curso curso3 = new Curso(null, "Educação Fisica");
		ctrl.inserir(curso1);
		ctrl.inserir(curso2);
		ctrl.inserir(curso3);
		...
		System.out.println("--------------------------------------------------");
		/* Buscar curso com o ID 3 */
		System.out.println("Buscar pelo id 3: " + ctrl.buscaPorId(3));

		System.out.println("--------------------------------------------------");
		/* Alterando o curso*/
		curso3.setNmCurso("Nutricão");;
		ctrl.alterar(curso3);

		System.out.println("--------------------------------------------------");
		/* Excluindo curso */
		ctrl.excluir(curso3.getIdCurso());
		System.out.println("Cursos Cadastrados");
		for (Curso curso : ctrl.buscaTodos()) {
			System.out.println(curso);
		}
	...
	public void testeCrudAluno(AlunoCtrl ctrl, PessoaCtrl pessoaCtrl, CursoCtrl cursoCtrl) {
		...
		System.out.println("--------------------------------------------------");
		/* Inserir Alunos */
		Aluno aluno1 = new Aluno(null, new Date(2020, 3, 16), true, pessoaCtrl.buscaPorId(2), cursoCtrl.buscaPorId(1));
		Aluno aluno2 = new Aluno(null, new Date(2019, 8, 20), false, pessoaCtrl.buscaPorId(4), cursoCtrl.buscaPorId(2));
