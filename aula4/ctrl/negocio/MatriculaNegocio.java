...
public class MatriculaNegocio {
	...
	// READ
	public List<Matricula> buscaTodos() throws MatriculaException, AlunoException, OfertaExcetion, CursoException, ProfessorExcetion, DisciplinaExection{
	...
	public Matricula buscaPorId(Integer id) throws MatriculaException, AlunoException, OfertaExcetion, ProfessorExcetion, DisciplinaExection {
