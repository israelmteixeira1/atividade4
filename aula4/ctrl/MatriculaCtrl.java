...
public class MatriculaCtrl {
	...
	public List<Matricula> buscaTodos() throws CursoException, ProfessorExcetion, DisciplinaExection {
	...
	public Matricula buscaPorId(Integer id) throws ProfessorExcetion, DisciplinaExection {
